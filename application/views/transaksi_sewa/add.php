<?php echo form_open('transaksi_sewa/add',array("class"=>"form-horizontal")); ?>

	<div class="form-group">
		<label for="ID_SEWAAN" class="col-md-4 control-label">ID SEWAAN</label>
		<div class="col-md-8">
			<input type="text" name="ID_SEWAAN" value="<?php echo $this->input->post('ID_SEWAAN'); ?>" class="form-control" id="ID_SEWAAN" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="LAMA_SEWA" value="<?php echo $this->input->post('LAMA_SEWA'); ?>" class="form-control" id="LAMA_SEWA" />
		</div>
	</div>
	<div class="form-group">
		<label for="TOTAL_TARIF" class="col-md-4 control-label">TOTAL TARIF</label>
		<div class="col-md-8">
			<input type="text" name="TOTAL_TARIF" value="<?php echo $this->input->post('TOTAL_TARIF'); ?>" class="form-control" id="TOTAL_TARIF" />
		</div>
	</div>
