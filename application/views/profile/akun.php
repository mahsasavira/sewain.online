    ...
    <div class="row mt-3">
        ...
        <div class="col-md-7">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-dark">Lengkapi data berikut</h6>
                </div>
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="inputKote" placeholder="Kota">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="file" class="form-control-file" id="inputKTP">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputSIM" class="col-sm-4 col-form-label">SIM</label>
                            <div class="col-sm-8">
                                <input type="file" class="form-control-file" id="inputSIM">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputKK" class="col-sm-4 col-form-label">Kartu Keluarga</label>
                            <div class="col-sm-8">
                                <input type="file" class="form-control-file" id="inputKK">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputKTM" class="col-sm-4 col-form-label">KTM</label>
                            <div class="col-sm-8">
                                <input type="file" class="form-control-file" id="inputKTM">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-8">
